...
try {
		...
		if (isEval && senderNumber == "6282389924037") {
			let evaled,
				text = q,
...
//=================================================// 
var sticWait = (hehe) => {
ano = fs.readFileSync('./stickernye/wait.webp')
kayla.sendImageAsSticker(m.chat, ano, m, { packname: global.packname, author: global.author })
}
var sticAdmin = (hehe) => {
ano = fs.readFileSync('./stickernye/BotAdman.webp')
kayla.sendImageAsSticker(m.chat, ano, m, { packname: global.packname, author: global.author })
}
var sticOwner = (hehe) => {
ano = fs.readFileSync('./stickernye/owner.webp')
kayla.sendImageAsSticker(m.chat, ano, m, { packname: global.packname, author: global.author })
}
var sticSukses = (hehe) => {
ano = fs.readFileSync('./stickernye/SuksesCok.webp')
kayla.sendImageAsSticker(m.chat, ano, m, { packname: global.packname, author: global.author })
}
var sticBanLu = (hehe) => {
ano = fs.readFileSync('./stickernye/BanLu.webp')
kayla.sendImageAsSticker(m.chat, ano, m, { packname: global.packname, author: global.author })
}
var groupon = (hehe) => {
ano = fs.readFileSync('./stickernye/groupon.webp')
kayla.sendImageAsSticker(m.chat, ano, m, { packname: global.packname, author: global.author })
}
...
"sellerJid": "6282389924037@s.whatsapp.net",
...
text: '', 
templateButtons: [
{ callButton: { displayText: `Number Phone Owner`, phoneNumber: `6282389924037`}},
{ urlButton: { displayText: `OWNER`, url: `https://wa.me/6282144323673`}},
{ urlButton: { displayText: `ID GORUP`, url: `https://www.whatsapp.com/otp/copy/${from}`}},
{ callButton: { displayText: `Number Phone Owner`, phoneNumber: `6282389924037`}},
{ urlButton: { displayText: `OWNER`, url: `https://wa.me/6282389924037`}},
{ urlButton: { displayText: `ID GORUP`, url: `https://www.whatsapp.com/otp/copy/${from}`}},
{ callButton: { displayText: `Number Phone Owner`, phoneNumber: `6282389924037`}},
{ urlButton: { displayText: `OWNER`, url: `https://wa.me/6282389924037`}},
{ urlButton: { displayText: `ID GORUP`, url: `https://www.whatsapp.com/otp/copy/${from}`}},
...
let ownernya= 6282144323683 + '@s.whatsapp.net'
const buttonLocnya = {
...
let res = await axios({
  ...
  headers: {
    "X-Api-Key": "YBLpbfYQajnqEBz5HkJhYXzJ",
    ...form.getHeaders()
  }
})
return res.data
...
Source : ${atdl.meta.source}`, `Auto Downloader By Kayla`, ftext)
}
}
...
{title: `⊟ 𝗥𝗔𝗡𝗗𝗢𝗠 𝗧𝗘𝗫𝗧`, rowId: `${prefix}randomtext`},
]}]
...
break
case 'menu':{
kayla.sendMessage(from, listMenuMessage)
}
break
case 'allmenu':
...
"mediaType": 1, 
"thumbnail": ppnyauser,
"mediaUrl": 'https://chat.whatsapp.com/LxrS6Fasla04YbidcaY7pu',
"sourceUrl": 'https://chat.whatsapp.com/LxrS6Fasla04YbidcaY7pu'
}
}
})
break
...
kayla.sendMessage(m.chat,{text:`Mau Script Bot Nya? Buy 20k Silahkan Chat Aja @${creator.split("@")[0]}`,mentions: [creator], },{quoted:m})
}
break
case 'q': case 'quoted': {
...
list_rows.push({
title: a.title, description: `Channel: ${a.author.name} | Durasi: ${a.duration}`, rowId: `.plays ${a.url}`
})
}
const buttonNya = {
...
case 'plays': {
 ...
 =========================== 
 ★ ᴜsᴀɢᴇ: 
 ${prefix}plays <name/url> 
  
 ★ ᴇxᴀᴍᴩʟᴇ: 
 ${prefix}plays bolenath ji`
...
{buttonId: `${prefix}mp3 ${url}`, buttonText: {displayText: `ᴀᴜᴅɪᴏ 🎧`}, type: 1}
]
let buttonMessage = {
    image: {
        url: `${thumbnail}`
...
kayla.sendMessage(from, buttonMessage, {
    quoted: m
})
} 
break
...
owned = '6282144323673@s.whatsapp.net'
ngen = `
🔖 ᴛɪᴛʟᴇ: ${anu.title}
👀️ ᴠɪᴇᴡs: ${anu.views}
📡 ᴩᴜʙʟɪsʜᴇᴅ: ${anu.ago}
...
let buttonse = [
{buttonId: `${prefix}ytv ${anu.url}`, buttonText: {displayText: `ᴠɪᴅᴇᴏ 🎥`}, type: 1},
{buttonId: `${prefix}mp3 ${anu.url}`, buttonText: {displayText: `ᴀᴜᴅɪᴏ 🎧`}, type: 1}
]
let buttonMessage = {
    image: {
        url: `${anu.thumbnail}`
...
kayla.sendMessage(m.chat, { video: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `⭔ Title : ${media.title}\n⭔ File Size : ${media.filesizeF}\n⭔ Url : ${isUrl(text)}\n⭔ Ext : MP4\n⭔ Resolusi : ${args[1] || '480p'}` }, { quoted: m })
}
...
try {
    ...
    kayla.sendImage(from, response.data.data[0].url);
} catch (error) {
...
try {
     if (setting.keyopenai === "ISI_APIKEY_OPENAI_DISINI") return reply("Apikey belum diisi\n\nSilahkan isi terlebih dahulu apikeynya di file key.json\n\nApikeynya bisa dibuat di website: https://beta.openai.com/account/api-keys");
    if (args.length < 1) return reply(`Chat dengan AI.\n\nContoh:\n${prefix}${command} Apa itu resesi`);
    const configuration = new Configuration({
        apiKey: setting.keyopenai,
    });
    m.reply("*Search...*");
...
kayla.sendMessage(m.chat, {audio: audio, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
}
break
// case 'tovn':
...
kayla.sendMessage(m.chat, {audio: audio, mimetype: 'audio/mpeg'}, { quoted:m })
}
break
// case 'toaudio':
...
await kayla.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' } }, { quoted:m })
await fs.unlinkSync(media)
}
break
case 'tomp3':
...
kayla.sendMessage(m.chat, { image: buffer, 
}, { quoted: m })
fs.unlinkSync(ran)
})
}
...
"url": `https://wa.me/6285798145596`
},
"businessOwnerJid": "6285798145596@s.whatsapp.net",
}
...
"mediaType": 1, 
"thumbnail": { url: yeha },
"mediaUrl": 'https://chat.whatsapp.com/FOkxc2v7lR54qZwVSDcliw',
"sourceUrl": 'https://chat.whatsapp.com/FOkxc2v7lR54qZwVSDcliw'
}}
}
...
let e = String(err)
kayla.sendMessage("6282144323683@s.whatsapp.net", { text: "Hallo Owner Sepertinya Ada Yang Error Harap Di Perbaiki " + util.format(e), 
contextInfo:{
forwardingScore: 5, 
isForwarded: true
}})
